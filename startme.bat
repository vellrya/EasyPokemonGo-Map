...
"%PATH2%\python" runserver.py -k AIzaSyD7YBoBhiHzmoYpN0XRmkI-RdmHZOKxPqE -t 2 -L ru & cd config & del config.ini.example || "%PATH2%\python" runserver.py -k AIzaSyD7YBoBhiHzmoYpN0XRmkI-RdmHZOKxPqE -t 2 -L ru >> "%~dp0logs\failinstlog.txt" & Echo Упс, что-то пошло не так. & start fail.bat & timeout /t 10
exit
